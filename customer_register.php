...
?>
  ...
  <main>
    ...
    <div class="hero">
      <div class="heading">
        <span class="bold">Register</span> AT AMY COLLECTIONS
      </div>
      <p class="text">
      </p>
    </div>
...
$from = "amy.misango@gmail.com";

$message = "

<h2>
Email Confirmation By amy collections$c_name
</h2>

<a href='localhost/jumia/customer/my_account.php?$customer_confirm_code'>
